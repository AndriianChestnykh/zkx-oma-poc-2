  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-text-primary">Validation Result</h3>
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              <p className="text-text-tertiary">Total Policies</p>
              <p className="text-xl font-semibold text-text-primary">{result.evaluations.length}</p>
            </div>
            <div>
              <p className="text-text-tertiary">Passed</p>
              <p className="text-xl font-semibold text-green-600">
                {result.passedPolicies.length}
              </p>
            </div>
            <div>
              <p className="text-text-tertiary">Failed</p>
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-text-primary">Policy Evaluations</h4>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h5 className="font-medium text-text-primary">{evaluation.policyName}</h5>
                    ...
                    <p className="text-sm text-text-primary mb-2">{evaluation.reason}</p>
                    ...
                    {evaluation.metadata && Object.keys(evaluation.metadata).length > 0 && (
                      <details className="text-xs text-text-secondary">
                        ...
                        <pre className="mt-2 p-2 bg-surface rounded overflow-x-auto">
